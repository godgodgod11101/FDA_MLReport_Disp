...
```{r}
load(file = "rda_mdlData_fru/fruit_mdlData_raw.Rda")
```
...
# 中文level轉英文
levels(mdlData_pro[[2]]) <- c("Kaohsiung", "Keelung", "Taichung", "Taipei")
levels(mdlData_pro[[4]]) <- c("air", "ship")
levels(mdlData_pro[[7]]) <- c("Middle", "North", "South", "Null")
levels(mdlData_pro[[9]]) <- c("0", "1", "Null")
levels(mdlData_pro[[57]]) <- c("1", "0")
...
```{r}
# save(mdlData_pro_nb, file = "rda_mdlData_fru/fru_mdlData_pro_nb.Rda")
# save(mdlData_pro_bp, file = "rda_mdlData_fru/fru_mdlData_pro_bp.Rda")
# save(mdlData_pro_bg, file = "rda_mdlData_fru/fru_mdlData_pro_bg.Rda")
# save(mdlData_pro_bgOld, file = "rda_mdlData_fru/fru_mdlData_pro_bgOld.Rda")
# save(mdlData_pro_bi, file = "rda_mdlData_fru/fru_mdlData_pro_bi.Rda")
# save(mdlData_pro_bc, file = "rda_mdlData_fru/fru_mdlData_pro_bc.Rda")
```
