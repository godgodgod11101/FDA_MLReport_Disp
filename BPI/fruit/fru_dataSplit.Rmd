...
```{r}
load(file = "rda_mdlData_fru/fru_mdlData_pro_nb.Rda")
```
...
```{r}
# save(list_trainD, file = "rda_mdlData_fru/fru_trainD_1.Rda")
# save(testD, file = "rda_mdlData_fru/fru_testD_1.Rda")
```
...
fName <- dir("rda_mdlData_fru")[stringr::str_detect(dir("rda_mdlData_fru"), "pro")]
fPath <- file.path("rda_mdlData_fru", fName)
lapply(fPath, load, .GlobalEnv)
...
```{r}
# save(list_trainD_2, file = "rda_mdlData_fru/fru_trainD_2.Rda")
# save(list_testD_2, file = "rda_mdlData_fru/fru_testD_2.Rda")
```
