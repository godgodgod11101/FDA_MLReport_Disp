...
```{r}
load(file = "rda_mdlData_veg/veg_trainD_1.Rda")
load(file = "rda_mdlData_veg/veg_testD_1.Rda")
```
...
```{r}
# save(pred_result, file = "rda_result_veg/veg_pred_dateSplit.Rda")
```
...
```{r}
load(file = "rda_mdlData_veg/veg_testD_1.Rda")
load(file = "rda_result_veg/veg_pred_dateSplit.Rda")
```
...
write.csv(cfMxIndTab, file = "veg_dateRsl.csv", row.names = F)
