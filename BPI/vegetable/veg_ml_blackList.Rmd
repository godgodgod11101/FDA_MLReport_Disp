...
```{r}
load(file = "rda_mdlData_veg/veg_trainD_2.Rda")
load(file = "rda_mdlData_veg/veg_testD_2.Rda")
```
...
```{r}
# save(pred_result, file = "rda_result_veg/veg_pred_blackList.Rda")
```
...
```{r}
load(file = "rda_mdlData_veg/veg_testD_2.Rda")
load(file = "rda_result_veg/veg_pred_blackList.Rda")
```
...
write.csv(cfMxIndTab_1, file = "veg_blRsl_prod.csv", row.names = F)
...
write.csv(cfMxIndTab_2, file = "veg_blRsl_other.csv", row.names = F)
