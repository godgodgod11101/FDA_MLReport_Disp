...
```{r}
load(file = "rda_mdlData_spi/spices_mdlData_raw.Rda")
```
...
# 中文level轉英文
levels(mdlData_pro[[3]]) <- c("Kaohsiung", "Keelung", "Taichung", "Taipei")
levels(mdlData_pro[[5]]) <- c("air", "ship")
levels(mdlData_pro[[8]]) <- c("Middle", "North", "South", "Null")
levels(mdlData_pro[[10]]) <- c("0", "1", "Null")
levels(mdlData_pro[[47]]) <- c("1", "0")
...
```{r}
# save(mdlData_pro_nb, file = "rda_mdlData_spi/spi_mdlData_pro_nb.Rda")
# save(mdlData_pro_bp, file = "rda_mdlData_spi/spi_mdlData_pro_bp.Rda")
# save(mdlData_pro_bg, file = "rda_mdlData_spi/spi_mdlData_pro_bg.Rda")
# save(mdlData_pro_bgOld, file = "rda_mdlData_spi/spi_mdlData_pro_bgOld.Rda")
# save(mdlData_pro_bi, file = "rda_mdlData_spi/spi_mdlData_pro_bi.Rda")
# save(mdlData_pro_bc, file = "rda_mdlData_spi/spi_mdlData_pro_bc.Rda")
```
