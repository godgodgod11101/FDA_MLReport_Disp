...
```{r}
load(file = "rda_mdlData_spi/spi_trainD_1.Rda")
load(file = "rda_mdlData_spi/spi_testD_1.Rda")
```
...
```{r}
# save(pred_result, file = "rda_result_spi/spi_pred_dateSplit.Rda")
```
...
```{r}
load(file = "rda_mdlData_spi/spi_testD_1.Rda")
load(file = "rda_result_spi/spi_pred_dateSplit.Rda")
```
...
write.csv(cfMxIndTab, file = "spi_dateRsl.csv", row.names = F)
